...
const SingIn = () => {
    ...
    const { googleLongIn, singInEmailPassword } = useContext(AuthContext)
...
return (
    <div className='sing-in-page'>
        <div className="border w-full max-w-md mt-10 p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100 mx-auto">
            <h1 className="text-2xl font-bold text-center">Sing In</h1>
            <form onSubmit={handelSignInWithEmail} className="space-y-6 ng-untouched ng-pristine ng-valid">
